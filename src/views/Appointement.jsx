...
function Appointement() {
  ...
  function disableMinuteByHourAndDay(day, hour) {
    ...
    const filteredAppointement = appointement.filter((appointement) => {
      return (
        appointement.startingTime.slice(0, 10) == formatedDay &&
        appointement.startingTime.slice(11, 13) == formatedHour
      );
    });
  ...
  const createAppointement = () => {
    if (!user.verified) return toast.error("Please verify your email first");
    ...
    if (
      ...
      const formatedStartWithDay =
        moment(selectedDay).format("YYYY-MM-DD") + " " + formatedStart;
      const formatedEndWithDay =
        moment(selectedDay).format("YYYY-MM-DD") + " " + formatedEnd;

      axios
        .post(`${import.meta.env.VITE_API_PATH}/appointement`, {
      ...
      <div className="p-4 ml-64 custom-padding-top">
        <div className="p-4 border-2 border-gray-200 rounded-lg dark:border-gray-700 ">
          ...
          <p className="text-sm text-gray-500 dark:text-gray-400">
            Here you can create appointement with the doctor of your choice
          </p>
                ...
                <>
                  <tbody>
                    <tr className="bg-white border-b dark:bg-gray-900 dark:border-gray-700">
                      ...
                      <td className="px-6 py-4">
                        <button
                          onClick={() => showAppointementModal(doctor)}
                    ...
                    <form className="space-y-6" action="#">
                      ...
                      {selectedDay && (
                        <div className="flex flex-row justify-around">
                          <div>
                            <p className="mb-4 text-l font-medium text-gray-900 dark:text-white">
                              Starting Time
                            </p>
                            <TimePicker
